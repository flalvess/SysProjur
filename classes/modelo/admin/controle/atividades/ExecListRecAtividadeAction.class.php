...
class ExecListRecAtividadeAction extends AbstractAction {
    protected $tplLista = 'atividades/tabelaAtividadeRec.tpl';
    ...
    public function execute() {
        ...
        $controlValidation = GestaoAtividadeRec::validateRequestList ( $rawRequest );
        ...
        if ($controlValidation->isValid ()) {
            ...
            $params ['li'] = (($pag - 1) * GestaoAtividadeRec::NUM_ITENS);

            $filtro = GestaoAtividadeRec::filtroBasico ( $params );
