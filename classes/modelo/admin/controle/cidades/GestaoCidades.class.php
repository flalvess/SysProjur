...
class GestaoCidades {
    ...
    public function getCamposOrdemLista($formatMap = FALSE) {
        ...
        $map ['0'] ['campo'] = "tbcidade.idCidade";
        $map ['1'] ['label'] = "Cidade";
        $map ['1'] ['campo'] = "tbcidade.nome";
        $map ['2'] ['label'] = "Estado";
        $map ['2'] ['campo'] = "tbestado.nome";
    ...
    public static function validateRequestList($rawRequest) {
        ...
        $controlValidation->addValidator(new NoValidator("cidade", ""));
    ...
    public static function validateReqCompCidades($rawRequest) {
        $controlValidation = new ValidationFacade ( );
    ...
    public static function filtroBasico($params) {
        $cidade = (isset($params ['cidade'])) ? ($params ['cidade']) : ("");
        ...
        $strWhere = "1=1";
        $strWhere .= ($ordem == 1) ? (" and tbcidade.nome like '{$cidade}%'") : ("");
        $strWhere .= ($ordem == 2) ? (" and tbestado.nome like '{$cidade}%'") : ("");
        ...
        $filtro ['tabelas'] = "tbcidade";
        $filtro ['campos'] = "tbcidade.*, tbestado.idEstado, tbestado.nome as estado";
        $filtro ['join'] = "inner join tbestado on tbcidade.fkEstado = tbestado.idEstado";
        $filtro ['group'] = "";
