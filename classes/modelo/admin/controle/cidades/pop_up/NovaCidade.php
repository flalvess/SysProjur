...
if($cadastro == "cadastrar"){
    $insert ="insert into tbcidade values(null, '$cidade', $estado)";
    mysql_query($insert);
    ...
    <body>
        ...
        <div  class="field" style="display: block; background-color:#f8fafc; border: 1px solid #AED7FC; height: 28px; width: 100%; font-family: Arial; color: #333333; padding-top: 5px; padding-bottom: 3px;  font-size: 12px; margin-left: -10px; margin-top: -12px;">
            ...
            <select name="consulta_estado"  style="width: 265px; margin-left: 8px; height: 25px;" class="input_text" ONCHANGE="location = this.options[this.selectedIndex].value;">
                ...
                <option value="NovaCidade.php?estado=<?=$tupla_estado['nome']?>&consulta_estado=yes" ><?=$tupla_estado['nome']?> - <?=$tupla_estado['sigla']?></option>
        ...
        <form  method="get" action="NovaCidade.php">
            <div class="container_field_new" style=" width: 100%;  background-color: white; height: 50px; margin-left: 10px;">
                ...
                <div class="field" style="margin-bottom: 7px; width: 250px; padding-right: 5px !important; padding-left: 0px !important">
                    ...
                    <input type="text" name="cidade" id="txtNome" size="60" class="input_text" style="width: 250px; text-align: left; height: 25px;"/>
                ...
                <div class="field" style=" width: 170px !important;  padding-left: 5px;">
                    ...
                    <select name="estado"  style="width: 165px; height: 25px;" class="input_text">
                        ...
                        <option value="<?php echo $tupla_estado2['idEstado']; ?>"><?php echo $tupla_estado2['nome']; ?> - <?php echo $tupla_estado2['sigla']; ?></option>
                ...
                <table id="tablelist" summary="Listagem" class="tablelist" border="0" cellpadding="0" cellspacing="0" width="99%" style="padding: 0px 0px 0px 0px;">
                    ...
                    <tbody>
                        ...
                        <tr style="height:25px">
                            ...
                            <td  class="lista"><a href="alterarCidade.php?idCidade=<?php echo $lista_cidade_estado['idCidade']; ?>&cidade=<?php echo $lista_cidade_estado['cidade']; ?>&estado=<?php echo $lista_cidade_estado['idEstado']; ?>"><img src="../../../../../../img/admin/edit1.png" title="Alterar dados da cidade"/></a>&nbsp;&nbsp;&nbsp;<a href="excluirCidade.php?idCidade=<?php echo $lista_cidade_estado['idCidade']; ?>" onClick="return confirm('Tem certeza que quer EXCLUIR ESTA CIDADE?')"><img src="../../../../../../img/admin/delete_user.png" title="Excluir esta cidade"/></a></td>
                        </tr>
