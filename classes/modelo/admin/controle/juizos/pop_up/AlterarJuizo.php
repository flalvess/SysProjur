...
if($consulta_cidade =="yes"){
    ...
    $query_juizo_cidade = "select tbjuizo.nome as juizo, tbjuizo.idJuizo, tbcidade.idCidade, tbcidade.nome as cidade from tbcidade inner join tbjuizo on tbcidade.idCidade = tbjuizo.fkCidade order by tbjuizo.idJuizo desc";
    $resultado_juizo_cidade = mysql_query($query_juizo_cidade);
}


if($alteracao == "alterar"){
    $update ="update tbjuizo set nome='$juizo', fkCidade=$cidade where idJuizo = $idJuizo";
    mysql_query($update);
    ...
    <body>
        ...
        <div  class="field" style="display: block; background-color:#f8fafc; border: 1px solid #AED7FC; height: 28px; width: 100%; font-family: Arial; color: #333333; padding-top: 5px; padding-bottom: 3px;  font-size: 12px; margin-left: -10px; margin-top: -12px;">
            ...
            <select name="consulta_cidade"  style="width: 265px; margin-left: 8px; height: 25px;" class="input_text" ONCHANGE="location = this.options[this.selectedIndex].value;">
                ...
                <option value="NovoJuizo.php?cidade=<?php echo $tupla_cidade['nome'];?>&consulta_cidade=yes" ><?php echo $tupla_cidade['nome']; ?> - <?php echo $tupla_cidade['sigla'];?></option>
        ...
        <form  method="get" action="AlterarJuizo.php">
            <input type="hidden" name="idJuizo" value="<?php echo $idJuizo; ?>"/>
            <div class="container_field_new" style=" width: 100%;  background-color: white; height: 50px; margin-left: 10px;">
                ...
                <div class="field" style="margin-bottom: 7px; width: 250px; padding-right: 5px !important; padding-left: 0px !important">
                    ...
                    <!--   <b style="float: left; margin-left: 0px;">Nova juizo &nbsp</b> -->

                    <label for="formSaveJuizo_nome" class="lbl">Juizo:</label>
                    <input type="text" name="juizo" id="txtNome" size="60" value="<?php echo $juizo; ?>" class="input_text" style="width: 250px; text-align: left; height: 25px;"/>
                ...
                <div class="field" style=" width: 170px !important;  padding-left: 5px;">
                    ...
                    <select name="cidade"  style="width: 165px; height: 25px;" class="input_text">
                        ...
                        <option value="<?php echo $tupla_cidade2['idCidade']; ?>" <?php if( $tupla_cidade2['idCidade'] == $cidade){ echo "selected='selected'";}?>><?php echo $tupla_cidade2['nome']; ?></option>
