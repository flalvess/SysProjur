...
class GestaoMovimentacao {
    ...
    public static function filtroBasico($params) {
        ...
        $filtro ['campos'] = "tbmovimentacao.idMovimentacao, tbmovimentacao.numeroMovimentacao, tbmovimentacao.tipoMovimentacao, tbmovimentacao.evento, tbmovimentacao.data, tbmovimentacao.perfil, tbmovimentacao.movimentadoPor, tbmovimentacao.arquivo, tbmovimentacao.observacao, tbmovimentacao.ciente";
