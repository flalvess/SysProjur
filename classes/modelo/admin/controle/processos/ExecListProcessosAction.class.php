...
class ExecListProcessosAction extends AbstractAction {
    ...
    public function execute() {
        ...
        $controlValidation = GestaoProcessos::validateRequestList ( $rawRequest );
        ...
        if ($controlValidation->isValid ()) {
            ...
            $params ['li'] = (($pag - 1) * GestaoProcessos::NUM_ITENS);

            $filtro = GestaoProcessos::filtroBasico ( $params );
