...
class GestaoProcessosMeusProcessos {
    const NUM_ITENS = 10;
    ...
    public static function validateRequestCad($rawRequest, $edit = false) {
        ...
        if($edit) {
            ...
            if($rawRequest->getForValidation ( 'tipoSegundaInstancia' ) == GestaoProcessos::TIPO_SEGUNDA_INSTANCIA_DERIVADO) {
               // $controlValidation->addValidator(new StringNotEmptyValidator("primeiraInstancia", "A PRIMEIRA deve ser informado."));
                  ...
                  $controlValidation->addValidator(new InteiroPositivoValidator("fkPrimeiraInstancia", "A segundaii deve ser informado."));
            }
        }
        ...
        $controlValidation->addValidator(new ArrayValidator("total", "O TIPO DO PROCESSO deve ser informado."));
        $controlValidation->addValidator(new ArrayValidator("nome", "O TIPO DO PROCESSO deve ser informado."));
        ...
        if($modo['modo'] == 'M') {
            ...
            $controlValidation->addValidator(new StringNotEmptyValidator("usuario", "A SITUAÇÃO DO PROCESSO deve ser informado."));
        }
        ...
        if($rawRequest->getForValidation ( 'instancia' ) == GestaoProcessos::TIPO_PRIMEIRA_INSTANCIA) {
            ...
            $controlValidation->addValidator(new InteiroPositivoValidator("cidade", "O JUÍZO deve ser informado."));
        ...
        if($rawRequest->getForValidation ( 'tipoSegundaInstancia' ) == GestaoProcessos::TIPO_SEGUNDA_INSTANCIA_DERIVADO) {
            //$controlValidation->addValidator(new StringNotEmptyValidator("primeiraInstancia", "A PRIMEIRA deve ser informado."));
            $controlValidation->addValidator(new InteiroPositivoValidator("primeiraInstancia", "A PRIMEIRA deve ser informado."));
            //  $controlValidation->addValidator(new InteiroPositivoValidator("fkSegundaInstancia", "A segunda deve ser informado."));
              $controlValidation->addValidator(new NoValidator("fkPrimeiraInstancia", "A segundaii deve ser informado."));
        }
