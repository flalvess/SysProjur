...
class ExecListProcessosSemCienteAction extends AbstractAction {
    ...
    public function execute() {
        ...
        $controlValidation = GestaoProcessosSemCiente::validateRequestList ( $rawRequest );
        ...
        if ($controlValidation->isValid ()) {
            ...
            $params ['li'] = (($pag - 1) * GestaoProcessosSemCiente::NUM_ITENS);

            $filtro = GestaoProcessosSemCiente::filtroBasico ( $params );
            ...
            if ($lista ['numItens'] > 0) {
                ...
                while($i != count($teste)){
                    //$i++;
                    $valor[] = DAOMovimentacao::numeroSemCiente($teste[$i]);
                    $i++;
                }

                $tela->assign ( "quantidadeSemCiente", $valor );
