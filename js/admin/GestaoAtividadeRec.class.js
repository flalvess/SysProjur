var GestaoAtividadeRec = Class.create(
	{});


GestaoAtividadeEnv.initCad = function()
{
	ajaxOptions =
	{
...
GestaoAtividadeEnv.cadAtividade = function(objLink)
{
...
GestaoAtividadeRec.initListRec = function()
{
	ajaxOptions =
	{
		parameters :"ACTION=InitListRecAtividadeAction"
	}

	new Ajax.Request(ConfigAdmin.URL_APP, ajaxOptions);
}

GestaoAtividadeRec.execListRec = function()
{
	$('formListAtividade').action = ConfigAdmin.URL_APP;
	$('formListAtividade').request();
}

GestaoAtividadeRec.initEdit = function(id)
{
	ajaxOptions =
	{
