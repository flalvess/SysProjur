...
<div class="icons">
    <ul>
        <li><span id="add"><a href="javascript:;" onclick="GestaoProcessos.initCad()" title="Incluir Novo Usuário"><img src="{$smarty.const.HTTP_URL}img/admin/add_user.png" alt=""/>Incluir Novo</a></span></li>
        <li><span id="delete"><a href="javascript:;" onclick="GestaoProcessos.execDel()" title="Deletar Usuário"><img src="{$smarty.const.HTTP_URL}img/admin/delete_user.png" alt=""/>Deletar Seleção</a></span></li>
        <li>
            <span id="busca">
...
<div id="search" style="display:none">
    <form action="" method="post" id="formListProcesso" onsubmit="GestaoProcessos.execListAExecutar(); return false">
        <input type="hidden" name="ACTION" value="ExecListProcessosAExecutarAction" />
