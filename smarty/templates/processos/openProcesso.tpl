<div class="icons">
    <ul>
        ...
        <!--   <li style="float: right;"><span id="add">
                  <a href="javascript:GestaoProcessos.viewProcesso('{$processo.idProcesso}', '{$processo.numeroProcesso}', '{$processo.instancia}', '{$numeroProcesso}', '{$primeira.cidade}','{$primeira.juizo}');" title="Visualizar dados do processo"><img src="{$smarty.const.HTTP_URL}img/admin/excel.png" alt=""/><font style="color: #339900; font-size: 8pt"><b><u>Relatório</u></b></font></a></span>
          </li>    -->
    </ul>
    ...
    <span id="add" style="float: right; padding-right: 5px; padding-left: 5px; border: 1px solid orange; margin-right: 5px; background: #ffff99; padding-bottom: 2px;">
        <a href="javascript:GestaoProcessos.viewProcesso('{$processo.idProcesso}', '{$processo.numeroProcesso}', '{$processo.instancia}', '{$numeroProcesso}', '{$primeira.cidade}','{$primeira.juizo}');" title="Visualizar dados do processo" style="text-decoration: none;"><img src="{$smarty.const.HTTP_URL}img/admin/excel.png" style="vertical-align:  middle" alt=""/><b style="color: black; font-size: 8pt; color: green;"><u>Exportar Excel</u></b></a>
    </span>
