<?php /* Smarty version 2.6.12, created on 2011-02-11 16:54:24
         compiled from pessoas/listPessoas.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'pessoas/listPessoas.tpl', 36, false),)), $this); ?>
<div class="icons">
    <ul>
        <li><span id="add"><a href="javascript:;" onclick="GestaoPessoas.initCad()" title="Incluir Novo Usuário"><img src="<?php echo @HTTP_URL; ?>
img/admin/add_user.png" alt=""/>Incluir Novo</a></span></li>
        <li><span id="delete"><a href="javascript:;" onclick="GestaoPessoas.execDel()" title="Deletar Usuário"><img src="<?php echo @HTTP_URL; ?>
    ...
    <form action="" method="post" id="formListPessoa" onsubmit="GestaoPessoas.execList(); return false">
        ...
        <fieldset>
            ...
            <table class="container_busca" align="center">
                ...
                <tr>
                    <td>
                        <input id="formListPessoa_pessoa" type="text" class="text" name="pessoa" title="Critérios: teste" style="width: 300px;"/>
                    </td>
                    <td>
                ...
                <tr>
                    <td colspan="2">
                        <select size="1" id="formListPessoa_ordem" class="text" name="ordem" title="Representa o critério usado para ordenar os resultados." style="width: 105px;">
				...
				<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['optionsOrdem']), $this);?>
                        ...
                        <select size="1" id="formListPessoa_sentido" class="text" name="sentido" title="Trata-se da forma como os resultados serão ordenados.">
