<?php /* Smarty version 2.6.12, created on 2011-02-23 12:19:55
...
css/admin/listar.css"  media="screen"/>
        <link rel="stylesheet" type="text/css" href="<?php echo @HTTP_URL; ?>
css/admin/format_campos.css"  media="screen"/>
        <link rel="stylesheet" type="text/css" href="<?php echo @HTTP_URL; ?>
...
css/admin/jquery-ui-1.8.4.custom.css"  media="screen"/>
   ...
   <!--     <link rel="stylesheet" type="text/css" href="<?php echo @HTTP_URL; ?>
js/base/ckeditor/_samples/sample.css" />
...
js/base/jquery.ui.datepicker.js"></script>
       ...
       <!--  <script language="javascript" type="text/javascript" src="<?php echo @HTTP_URL; ?>
js/base/ckeditor/ckeditor.js"></script>
        ...
        <script language="javascript" type="text/javascript" src="<?php echo @HTTP_URL; ?>
js/base/ckeditor/_samples/sample.js"></script> -->
...
js/admin/GestaoUsuarios.class.js"></script>
        <script language="javascript" type="text/javascript" src="<?php echo @HTTP_URL; ?>
js/admin/GestaoMovimentacao.class.js"></script>
        <script language="javascript" type="text/javascript" src="<?php echo @HTTP_URL; ?>
js/admin/GestaoProcessos.class.js"></script>
        <script language="javascript" type="text/javascript" src="<?php echo @HTTP_URL; ?>
js/admin/GestaoProcurador.class.js"></script>
        <script language="javascript" type="text/javascript" src="<?php echo @HTTP_URL; ?>
js/admin/GestaoPrimeiraInstancia.class.js"></script>
        <script language="javascript" type="text/javascript" src="<?php echo @HTTP_URL; ?>
js/admin/GestaoJuizos.class.js"></script>
        <script language="javascript" type="text/javascript" src="<?php echo @HTTP_URL; ?>
js/admin/GestaoAtividade.class.js"></script>
        <script language="javascript" type="text/javascript" src="<?php echo @HTTP_URL; ?>
js/admin/GestaoAtividadeEnv.class.js"></script>
        <script language="javascript" type="text/javascript" src="<?php echo @HTTP_URL; ?>
js/admin/GestaoAtividadeRec.class.js"></script>
        <script language="javascript" type="text/javascript" src="<?php echo @HTTP_URL; ?>
js/admin/GestaoPessoas.class.js"></script>
        <script language="javascript" type="text/javascript" src="<?php echo @HTTP_URL; ?>
js/admin/GestaoCidades.class.js"></script>
        <script language="javascript" type="text/javascript" src="<?php echo @HTTP_URL; ?>
js/admin/GestaoAssunto.class.js"></script>
        <script language="javascript" type="text/javascript" src="<?php echo @HTTP_URL; ?>
js/admin/GestaoSubstituicoes.class.js"></script>
        <script language="javascript" type="text/javascript" src="<?php echo @HTTP_URL; ?>
js/admin/Pessoa.js"></script>
        <script language="javascript" type="text/javascript" src="<?php echo @HTTP_URL; ?>
js/admin/ParteAdversa.js"></script>
        <script language="javascript" type="text/javascript" src="<?php echo @HTTP_URL; ?>
js/admin/GestaoHistorico.class.js"></script>
    <!--    <script language="javascript" type="text/javascript" src="<?php echo @HTTP_URL; ?>
js/base/fckeditor/fckeditor.js"></script> -->
    <!--    <script language="javascript" type="text/javascript" src="<?php echo @HTTP_URL; ?>
js/base/ckeditor/ckeditor.js"></script> -->
...
img/admin/ajax-loader.gif" title="Carregando..." /> -->
                <img src="<?php echo @HTTP_URL; ?>
img/admin/25.gif" title="Carregando..." />
            </div>
            <div id="topo">
                <div id="logo">
