<?php /* Smarty version 2.6.12, created on 2011-02-19 15:53:49
         compiled from historico/listHistorico.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'historico/listHistorico.tpl', 36, false),)), $this); ?>
<div class="icons">
    <ul>
     <!--   <li><span id="add"><a href="javascript:;" onclick="GestaoHistoricos.initCad()" title="Incluir Novo Usuário"><img src="<?php echo @HTTP_URL; ?>
img/admin/add_user.png" alt=""/>Incluir Novo</a></span></li>
        <li><span id="delete"><a href="javascript:;" onclick="GestaoHistoricos.execDel()" title="Deletar Usuário"><img src="<?php echo @HTTP_URL; ?>
