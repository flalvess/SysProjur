<?php /* Smarty version 2.6.12, created on 2011-02-11 12:40:18
         compiled from processos/cadProcesso.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'processos/cadProcesso.tpl', 71, false),)), $this); ?>
<div class="icons">
    <ul>
...
" />
        ...
        <fieldset>
            ...
            <?php $_from = $this->_tpl_vars['primeiraInstancia']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['primeira']):
?>
...
?>
            ...
            <input type="hidden" name="fkSegundaInstancia" value="<?php echo $this->_tpl_vars['segunda']['idSegundaInstancia']; ?>
" />
            ...
            <div class="" style="border-left: 1px solid #A9D5FB; border-bottom: 1px solid #A9D5FB; background-color: white; float: right; margin-top: -20px; padding-right: 5px; padding-left: 5px; padding-bottom: 2px;">
                ...
                <?php if ($this->_tpl_vars['modoDistribuicao'] == 'M'): ?>
            ...
            <div class="container_field_new">
                <label for="Processo" style="font-weight: bold; margin-left: 20px; font: bold 14px arial">Processo<a href="javascript:;" onclick="GestaoProcessos.ocultarProcesso();" title="Ocultar/Mostrar formulário"><img src="<?php echo @HTTP_URL; ?>
img/admin/seta1.png" alt=""/></a><label id="labelProcesso" style="font-size: 8pt; color: #999999"><i> Passe o mouse em cima dos campos para obter uma descrição</i></label></label>
            </div>
            ...
            <div class="container_field_new" id="processo" style="padding-top:15px;  background-color: #f8fafc; border: 1px solid #AED7FC; padding: 5px 5px 5px 5px; width: 670px; margin-left: 20px;">
                ...
                <div class="field">
                    ...
                    <input id="formSaveProcesso_numeroProcesso" name="numeroProcesso" type="text" maxlength="14" class="input_text" value="<?php echo $this->_tpl_vars['processo']['numeroProcesso']; ?>
" title="Digite no máx. 14 dígitos"/>
                ...
                <div class="field">
                    ...
                    <input id="formSaveProcesso_tipoAcao" name="tipoAcao" type="text" class="input_text" value="<?php echo $this->_tpl_vars['processo']['tipoAcao']; ?>
" title="Escreva o tipo da acao. Ex.: carta precatória"/>
                ...
                <div class="field" style="width: 500px !important;">
                    ...
                    <!--  <textarea id="formSaveProcesso_assunto" name="assunto" class="input_text" style="width: 300px; height: 50px; margin-left: 5px;"  title="Escreva o assunto do processo"><?php echo $this->_tpl_vars['processo']['assunto']; ?>
</textarea> -->
                    <input id="formSaveProcesso_assunto" name="assunto" type="text" class="input_text" style="width: 500px !important;" value="<?php echo $this->_tpl_vars['processo']['assunto']; ?>
" title="Digite o assunto do processo"/>
                ...
                <div class="field_textarea" style="height: 75px; margin-bottom: 20px;">
                    ...
                    <textarea id="formSaveProcesso_descricao" name="descricao" class="input_text" style="width: 300px; height: 50px; margin-left: 5px;"  title="Escreva uma descriçao/observaçao"><?php echo $this->_tpl_vars['processo']['descricao']; ?>
</textarea>
                ...
                <div class="field" style="width: 100px !important;">
                    ...
                    <select id="formSaveProcesso_situacaoProcesso" name="situacaoProcesso" class="input_text" style="width: 200px;" title="Informe a situação do processo">
                        ...
                        <?php echo smarty_function_html_options(array('values' => $this->_tpl_vars['valueSituacao'],'output' => $this->_tpl_vars['outSituacao'],'selected' => $this->_tpl_vars['processo']['situacaoProcesso']), $this);?>
            ...
            <div class="container_field_new" style="margin-top:15px;">
                <label for="Processo" style="top:5px; font-weight: bold; margin-left: 20px; font: bold 14px arial">Justiça<a href="javascript:;" onclick="GestaoProcessos.ocultarJustica();" title="Ocultar/Mostrar formulário"><img src="<?php echo @HTTP_URL; ?>
img/admin/seta1.png" alt=""/></a><label id="labelJustica" style="font-size: 8pt; color: #999999"><i> Passe o mouse em cima dos campos para obter uma descrição</i></label></label>
            </div>
            ...
            <div class="container_field_new" id="justica" style="padding-top:15px;  background-color: #f8fafc; border: 1px solid #AED7FC; padding: 5px 5px 5px 5px; width: 670px; margin-left: 20px;">
                <div class="field">
                    ...
                    <select id="formSaveProcesso_justica" name="justica" class="input_text" style="width: 200px;" title="Escolha a Justiça.">
                        <option value=""> ::Selecione:: </option>
                        <?php echo smarty_function_html_options(array('values' => $this->_tpl_vars['valueJustica'],'output' => $this->_tpl_vars['outJustica'],'selected' => $this->_tpl_vars['processo']['justica']), $this);?>

                    </select><br class="none"/>
                    <span class="aux_field" id="formSaveProcesso_auxField_justica">Escolha a justiça</span>
                </div>

                <?php if ($this->_tpl_vars['processo']['instancia'] == ""): ?>
                <div class="field field_new_right">
                    ...
                    <select id="formSaveProcesso_instancia" name="instancia" class="input_text"  style="width: 200px;" title="Informe a instância do processo" onchange="GestaoProcessos.changeProcessType();">
                        <option value=""> ::Selecione:: </option>
                        <?php echo smarty_function_html_options(array('values' => $this->_tpl_vars['valueInstancia'],'output' => $this->_tpl_vars['outInstancia'],'selected' => $this->_tpl_vars['processo']['instancia']), $this);?>
                ...
                <div class="field field_new_right">
                    <label for="formSaveProcesso_instancia" class="lbl">Instancia:</label>
                    <select id="formSaveProcesso_instancia" name="instancia" class="input_text" style="width: 200px;"  title="Informe a instância do processo" onchange="GestaoProcessos.changeProcessType();">
                        <option value="<?php echo $this->_tpl_vars['processo']['instancia']; ?>
" selected > <?php echo $this->_tpl_vars['processo']['instancia']; ?>
 </option>
                    </select><br class="none"/>
                ...
                <fieldset id="primeiraInstancia" class="none" style="padding-top:15px; background-color:  #f8fafc;">
                    <div class="field" >
                        ...
                        <select id="formSaveProcesso_cidade" class="input_text" style="width: 200px;" name="cidade" onchange="GestaoProcessos.loadJuizos(this.value)" title="Escolha a cidade">
                            ...
                            <?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['optionsCidade'],'selected' => $this->_tpl_vars['primeira']['idCidade']), $this);?>
				 ...
				 Escreva o nome da cidade
                    ...
                    <div class="field" style="margin-bottom: 20px; border: none; width: 130px !important; ">
                        ...
                        <select id="formSaveProcesso_fkEstado" class="input_text" name="fkEstado" title="Selecione o estado" style=" width: 106px;">
                            ...
                            <?php echo smarty_function_html_options(array('values' => $this->_tpl_vars['valueEstado'],'output' => $this->_tpl_vars['outEstado'],'selected' => $this->_tpl_vars['cidade']['fkEstado']), $this);?>
                ...
                <div class="container_field_new" style="padding-top:15px;" >
                    <?php if ($this->_tpl_vars['segunda']['tipoSegundaInstancia'] == ""): ?>
                    <div id="segundaInstancia" class="field none">
                        ...
                        <select id="formSaveProcesso_tipoSegundaInstancia" name="tipoSegundaInstancia" class="input_text" style="width: 200px;" title="Selecione o tipo do processo da 2º Intancia" onchange="GestaoProcessos.changePrimeiraInstancia();" >
                            <option value=""> ::Selecione:: </option>
                            <?php echo smarty_function_html_options(array('values' => $this->_tpl_vars['valueTipoSegundaInstancia'],'output' => $this->_tpl_vars['outTipoSegundaInstancia'],'selected' => $this->_tpl_vars['segunda']['tipoSegundaInstancia']), $this);?>
				...
				Selecione o tipo do processo da 2º Intancia
                    ...
                    <div class="field" id="segundaInstancia">
                        <label for="formSaveProcesso_tipoSegundaInstancia" class="lbl">Tipo:</label>
                        <select id="formSaveProcesso_tipoSegundaInstancia" name="tipoSegundaInstancia" class="input_text" style="width: 200px;" title="Selecione o tipo do processo da 2º Intancia" onchange="GestaoProcessos.changePrimeiraInstancia();" >
                            <option value="<?php echo $this->_tpl_vars['segunda']['tipoSegundaInstancia']; ?>
" selected > <?php echo $this->_tpl_vars['segunda']['tipoSegundaInstancia']; ?>
 </option>
                        </select><br class="none"/>
                        <span class="aux_field" id="formSaveProcesso_auxField_tipoSegundaInstancia">
				Selecione o tipo do processo da 2º Intancia
            ...
            <div class="container_field_new" style="margin-top:15px;">
                <label for="Processo" style="top:5px; font-weight: bold; margin-left: 20px; font: bold 14px arial"> Partes <a href="javascript:;" onclick="GestaoProcessos.ocultarParte();" title="Ocultar/Mostrar formulário"><img src="<?php echo @HTTP_URL; ?>
img/admin/seta1.png" alt=""/></a><label id="labelParte" style="font-size: 8pt; color: #999999"><i> Passe o mouse em cima dos campos para obter uma descrição</i></label></label>
            </div>
            ...
            <div class="container_field_new" id="parte" style="padding-top:15px; background-color: #f8fafc; border: 1px solid #AED7FC; padding: 5px 5px 5px 5px; width: 670px; margin-left: 20px;">
                <div class="field" style="height: auto; border: none; margin-right: 20px;">
                    ...
                    <input id="formSaveProcesso_pessoa" type="text" name="pessoa" value="" class="input_text"  title="Escreva o nome da parte representada"/><a href="javascript:;" onclick="adiciona(document.getElementById('formSaveProcesso_pessoa').value)" id="formSaveProcesso_teste"><img src="<?php echo @HTTP_URL; ?>
img/admin/add_u.png" style="margin-left: 5px;"/></a>
                ...
                <div class="field" style="height: auto; border: none; margin-left: 20px;">
                    ...
                    <input id="formSaveProcesso_parteAdversa" type="text" name="parteAdversa" value="" class="input_text"  title="Escreva o nome da parte adversa"/><a href="javascript:;" onclick="adicionaAdversa(document.getElementById('formSaveProcesso_parteAdversa').value)" ><img src="<?php echo @HTTP_URL; ?>
img/admin/add_u.png" style="margin-left: 5px;"/></a>
